...
class Topic:
    ...
    def post_copy_system_prompt(self, max_chars: int = 240,
        ...
        return (
            ...
            f"concrete surprising detail all work — address the reader as 'you' when it "
            f"fits (e.g. 'When you dial 911, will it actually work?', 'Your town could "
            f"hit pause on new data centers', 'No more phone during class in Kansas "
            f"schools'). Use everyday words and strong, active verbs. Strip ALL statute "
            ...
            f"wording fix to Illinois's electronic-records law.' A boring bill gets a "
            f"short, truthful line, never fake drama.\n"
